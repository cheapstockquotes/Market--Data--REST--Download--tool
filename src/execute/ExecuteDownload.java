...
public class ExecuteDownload {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("The list contains " + symbolList.size() + " records");
	...
	private static void getQuotes(ArrayList<Symbol> symbolList) throws Exception {
		/* creating a pool of 100 connections with a delay of 25ms between execution */
		/* rate limiting for single quotes is 40 quotes/second */
		ThreadPool threadPool = new ThreadPool(25, 25, TimeUnit.MILLISECONDS);
	...
	private static void getHistoricalQuotes(ArrayList<Symbol> symbolList) throws Exception {
		/* creating a pool of 100 connections with a delay of 50ms between execution */
